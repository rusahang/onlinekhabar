...
?>
<div class="o-container u-margin-buttom-40">
    <div class="o-row">
        <div class="o-row__column o-row__column--span-12 o-row__column--span-4@medium">
            <header>
                <?php echo get_avatar($author, 100); ?>
                <h2 class="u-margin-top-20"><b><?php echo esc_html($author_display) ?></b></h2>
                <div class="c-post-author__info">
                    <?php
                /* translators %s is the number of posts */
                printf(esc_html(_n('%s post', '%s posts', $author_posts, 'onlinekhabar')), number_format_i18n($author_posts));
                ?>
                    <br />
                    <?php if($author_website) { ?>
                    <a target="_blank"
                        href="<?php echo esc_url($author_website); ?>"><?php echo esc_html($author_website) ?></a>
                    <?php } ?>
                </div>
