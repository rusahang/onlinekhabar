<?php
function onlinekhabar_comment_callback( $comment, $args, $depth) {
    $tag = ( $args['style'] === 'div') ? 'div' : 'li';
    ?>
<<?php echo $tag ?> id="comment-<?php comment_ID(); ?>"
    <?php comment_class( ['c-comment', $comment->comment_parent ? 'c-comment--child' : ''] ) ?>>
    <article id="div-comment-<?php comment_ID(); ?>" class="c-comment__body">
        ...
        <?php edit_comment_link( esc_html__( 'Edit Comment', 'onlinekhabar' ), '<span class="c-comment__edit-link">', '</span>' ); ?>
        ...
        <div class="c-comment__content">
            ...
            <a class="c-comment__time" href="<?php echo esc_url( get_comment_link( $comment, $args ) ) ?>">
                <time datetime="<?php comment_time( 'c' ) ?>">
                    <?php
                            printf( esc_html__( '%s ago', 'onlinekhabar' ), human_time_diff( get_comment_time( 'U' ), current_time( 'U' ) ));
                        ?>
                </time>
            </a>
            ...
            <p class="c-comment__awaiting-moderation">
                <?php esc_html_e( 'Your comment is awaiting moderation.', 'onlinekhabar' ); ?></p>
            <?php } ?>
